...
export * from "../movie-app/genres/action/action.component";
export * from "../movie-app/genres/adventure/adventure.component";
export * from "../movie-app/genres/animation/animation.component";
export * from "../movie-app/genres/comedy/comedy.component";
export * from "../movie-app/genres/documentary/documentary.component";
